...
function Data() {
  return (
    <div className="home__data">
      ...
      <h3 className="home__subtitle">Technical Trainer & Speaker</h3>
      <p className="home__description">
      I am a passionate <b>Technical Trainer</b> with 6+ years of experience, having trained 10,000+ students across various colleges. I specialize in delivering hands-on learning experiences that bridge the gap between academics and industry. As a <b>Public speaker and team lead</b>, I thrive on mentoring, motivating, and guiding individuals toward technical excellence and career growth.
      </p>
